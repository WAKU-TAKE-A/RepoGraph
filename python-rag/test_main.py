...
class MainCliTests(unittest.TestCase):
    ...
    def test_show_isolation_json_includes_rule_family_summary(self) -> None:
        ...
        self.assertIn("python-rag/main.py show-ai-edges", payload["navigation_hints"]["recommended_commands"])
    ...
    def test_ai_candidates_bundle_path_writes_prompt_ready_json(self) -> None:
        ...
        self.assertIn(f"python-rag/main.py import-ai-edges <soft_edges.json> --workspace {str(self.workspace)}", payload["recommended_commands"])
